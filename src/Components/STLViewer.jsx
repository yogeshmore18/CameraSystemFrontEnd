...
import { Box, Button, Card, CardContent, CardHeader, Grid, MenuItem, Paper, Select, Typography } from "@mui/material";
...
// }
   ...
   const IssueDropDown = () => {
      return (
         <>
            <Select sx={{ marginRight: 15, height: '40px' }} value={selectedIssue} onChange={handleissue} displayEmpty
               inputProps={{ 'aria-label': 'Select an issue' }} >
               <MenuItem value="" disabled>
                  {selectedIssue === '' ? 'Select an issue' : ''}
               </MenuItem>
   ...
   return (
      <>
         <Box sx={{ display: 'flex' }}>
            <SideNav />
            <Box sx={{ flexGrow: 1, padding: 2, display: 'flex', flexDirection: 'column', marginTop: '70px' }}>

                <Grid container>
                  <Grid item xs={12}>
                     <Box display="flex" sx={{ marginLeft: '130px' }}>
                        <PlotButton />
                     </Box>
                  </Grid>
               </Grid>
               ...
               <div className="STLViewer-container">
                  ...
                  <Grid container>
                     <Grid sx={{ position: 'relative', display: 'flex' }} xs={9.5} md={9.5}>
                        ...
                        <Tooltip title="Reset view" arrow><Button onClick={resetControll} style={{ position: 'absolute', top: '15px', left: '150px' }}>
                           <RestartAltSharpIcon />
                        </Button>
                        </Tooltip>
                        {/* </div> */}
                     ...
                     <Grid item xs={2.5} md={2.5}>
                        ...
                        <Paper elevation={5} sx={{ marginBottom: 2 }}>
                           <Card>
                              <CardHeader
                                 sx={{ backgroundColor: '#3C5B6F', padding: 1 }}
                                 title={
                                    <Typography color="white" variant="subtitle2" fontWeight="bold">Pointer Size</Typography>
                                 }
                              />
                              <CardContent sx={{ display: 'flex', alignItems: 'center', }}>
                                 <Typography variant="body2">Pointer size:</Typography>                              
                                    <Fab size="small" sx={{ marginLeft:2, marginRight: 1 }} onClick={decreaseMarkerRadius} aria-label="decrease">
                                       <RemoveIcon sx={{ color: 'red' }} />
                                    </Fab>
                                    <Fab size="small" onClick={increaseMarkerRadius} aria-label="increase">
                        ...
                        <Paper elevation={5} sx={{ marginBottom: 2 }}>
                           <Card>
                              <CardHeader
                                 sx={{ backgroundColor: '#3C5B6F', padding: 1 }}
                                 title={
                                    <Typography  color="white" variant="subtitle2" fontWeight="bold">Selected Areas</Typography>
                                 }
                              />
                        ...
                        <Paper elevation={5}>
                           <Card>
                              <CardHeader
                                 sx={{ backgroundColor: '#3C5B6F', padding: 1 }}
                                 title={
                                    <Typography  color="white" variant="subtitle2" fontWeight="bold">Color Picker for Model</Typography>
                                 }
                              />
